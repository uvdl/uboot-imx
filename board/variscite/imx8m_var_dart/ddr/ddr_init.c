...
void ddr_init(void)
{
	...
	reg32_write(0x3c040290,0x6);
	reg32_write(0x3c040294,0x7);
	reg32_write(0x3c040298,0x4);
	reg32_write(0x3c04029c,0x5);
	reg32_write(0x3c044280,0x0);
	reg32_write(0x3c044284,0x3);
	reg32_write(0x3c044288,0x1);
	reg32_write(0x3c04428c,0x2);
